...
DEFAULT_MODELS = [
    ...
    ProviderModel(id="tts-cosyvoice-v35-flash", tenant_id=DEFAULT_TENANT_ID, name="CosyVoice v3 Flash", provider_type="tts",
                  provider_name="dashscope", model_name="cosyvoice-v3-flash",
                  config={"voice": "longanyang"}),
    ProviderModel(id="tts-cosyvoice-v35-plus", tenant_id=DEFAULT_TENANT_ID, name="CosyVoice v3 Plus", provider_type="tts",
